  ...
  useEffect(() => {
    if (hourlyRate && hours) {
      ...
      if (hoursType === "perWeek") {
        const weeks =
          startDate && endDate ? differenceInWeeks(endDate, startDate) + 1 : 1;
  ...
  const generatePDF = () => {
    ...
    doc.text(
      dueDate
        ...
        : format(issueDate, "MM/dd/yyyy") + " (upon receipt)",
      80,
      110
    );
    ...
    const totalHours =
      hoursType === "perWeek" && startDate && endDate
          ...
          <div className="p-4 md:p-8 space-y-8">
            <div className="space-y-2 text-center">
              ...
              <p className="text-muted-foreground">
                Make professional invoices in seconds
              </p>
            </div>
                  ...
                  <div className="flex items-center gap-2 pb-1">
                    ...
                    <TooltipProvider delayDuration={0}>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            You can also add your full legal name if you are
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Enter the payment and time information
                </p>
              </div>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        classNames={{
                          day_selected:
                            "bg-black text-white hover:bg-black hover:text-white focus:bg-black focus:text-white dark:bg-primary dark:text-primary-foreground dark:hover:bg-primary dark:hover:text-primary-foreground dark:focus:bg-primary dark:focus:text-primary-foreground",
              ...
              <div className="flex items-baseline justify-between">
                ...
                <div className="text-3xl font-bold flex items-center">
                  ...
                  {displayAmount
                    ...
                    .slice(1)}{" "}
                  {/* slice(1) removes the currency symbol as we're already displaying $ */}
                </div>
              </div>
              <Button
              ...
              <div className="grid gap-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {hoursType === "perWeek" ? "Hours/week" : "Total Hours"}:
                  </span>
                  <span>{hours}</span>
                </div>
                {startDate && endDate ? (
